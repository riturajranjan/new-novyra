...
/** The editorial hero — Article 01, linking to the real dynamic article
 * route at /blog/[slug] now that components/blog-article renders it. The
...
export function FeaturedInsight({ post }: FeaturedInsightProps) {
  ...
  return (
    ...
    >
      <Link
        href={`/blog/${post.id}`}
        className="group relative isolate flex h-full flex-col overflow-hidden rounded-2xl border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue sm:flex-row"
