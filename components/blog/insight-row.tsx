 ...
 * card. A faint accent-tinted glow appears behind the row on hover. Static
 * `<article>`, not a link — no article pages exist yet. */
export function InsightRow({ post, index }: InsightRowProps) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex items-center gap-4 border-t px-1 py-4 transition-colors duration-300 first:border-t-0 sm:py-4.5"
